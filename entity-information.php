<?php
 ...
 // Include Configuration File 
  ...
  $sql_forms = $data_fe->query("SELECT * FROM entity_information WHERE 1 ".$condition."");
  ...
  $result = $data_fe->query("SELECT * FROM entity_information WHERE 1 ".$condition." ORDER BY eId desc ".$pages->limit."");
        ...
        <div class="main-content-inner">
            ...
            <div class="page-content" style="overflow-x: auto">
                ...
                <?php  } ?>
                 ...
                 <?php 
                 if(isset($_SESSION['entity']['save']) and $_SESSION['entity']['save']!=''){
                 ?> 
                 <div class="pull-left alert alert-success no-margin alert-dismissable">
                    ...
                    <i class="ace-icon fa fa-umbrella bigger-120 blue"></i>
                      <?php echo $_SESSION['entity']['save'];?>
                  </div>
                <?php } unset($_SESSION['entity']['save']); ?>
            ...
            ?>
                        <tr>
                            ...
                            <td ><?php echo stripcslashes($data['_type']);?></td>
