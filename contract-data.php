<?php
 ...
 // Include Configuration File 
  ...
  $sql_forms = $data_fe->query("SELECT * FROM contract_data WHERE 1 ".$condition."");
  ...
  $result = $data_fe->query("SELECT * FROM contract_data WHERE 1 ".$condition." ORDER BY cId desc ".$pages->limit."");
        ...
        <div class="main-content-inner">
            ...
            <div class="page-content" style="overflow-x: auto">
                ...
                <?php  } ?>
                 ...
                 <?php 
                 if(isset($_SESSION['contract']['save']) and $_SESSION['contract']['save']!=''){
                 ?> 
                 <div class="pull-left alert alert-success no-margin alert-dismissable">
                    ...
                    <i class="ace-icon fa fa-umbrella bigger-120 blue"></i>
                      <?php echo $_SESSION['contract']['save'];?>
                  </div>
                <?php } unset($_SESSION['contract']['save']); ?>                
